...
<div id="installer-right">
	...
	<?php if ($messages['modules']) { ?>
		...
		<?php } ?>
	<?php } ?>
	<h2>Changelog v1.9.25</h2>
	<ul class="version-history">
		<li><span class="version-fixed">Fix</span> "Next week" and "Next weekend" options outputed wrong events when the current date was a Sunday.</li>
	</ul>

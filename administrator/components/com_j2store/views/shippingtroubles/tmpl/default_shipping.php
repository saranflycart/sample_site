 ...
 <?php else : ?>
  ...
  <?php endif;?>
	...
	<div class="span12">
     ...
     <?php else:?>
		<div class="alert alert-danger"><?php echo JText::sprintf('J2STORE_SHIPPING_TROUBLESHOOT_NOTE_MESSAGE','index.php?option=com_j2store&view=shippings','http://j2store.org/support/user-guide/standard-shipping.html');?></div>
     <?php endif;?>

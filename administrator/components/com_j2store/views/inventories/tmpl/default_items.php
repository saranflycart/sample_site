			...
			if($this->products && !empty($this->products)):
				...
				<tr>
							...
							<table id="variantListTable-<?php echo $item->j2store_product_id;?>" class="table table-condensed table-bordered hide">
								...
								<tbody>
										...
										<tr class="variants-list">
											...
											<td>
											<input type="text" size="2" id="quantity_<?php echo $variant->j2store_variant_id;?>" name="quantity[<?php echo $variant->j2store_variant_id;?>]" value="<?php echo $variant->quantity;?>">											
											<td>
					...
					<td>
					 ...
					 <td><input type="text" size="2" id="quantity_<?php echo $item->variant_id;?>" name="quantity[<?php echo $item->variant_id;?>]" value="<?php echo $item->quantity;?>"></td>
					 <td>

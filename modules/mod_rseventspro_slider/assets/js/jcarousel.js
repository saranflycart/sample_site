...
!function ($) {
  ...
  * ========================= */
  ...
  , slide: function (type, next) {
	...
	var $active_caption = $('#mod_slider_caption'+$active.attr('data_captions'));
	var $next_caption = $('#mod_slider_caption'+$next.attr('data_captions'));
  ...
  * ================= */
  ...
  $(document).on('click.rseprocarousel.data-api', '[data-slide], [data-slide-to]', function (e) {
	...
	$(document).ready(function($){
		...
		var details = jQuery('.mod_slider_caption').css('display');
		if(details!='none') {
			var details_height = jQuery('.mod_slider_caption').outerHeight();
			jQuery('.mod_slider_control').height(details_height);
			jQuery('.mod_slider_control').css('line-height',details_height+'px');
			jQuery('.mod_slider_caption_container').height(details_height);
			jQuery('.mod_slider_caption').height(details_height);
		}
	});
